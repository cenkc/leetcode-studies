...
* [64. Minimum Path Sum](https://leetcode.com/problems/minimum-path-sum/) (Difficulty: *Medium*)
    * [**Solution**](https://github.com/cenkc/leetcode-studies/blob/master/src/main/java/com/cenkc/leetcode/study/all/MinimumPathSum.java)
...
* [701. Insert into a Binary Search Tree](https://leetcode.com/problems/insert-into-a-binary-search-tree/) (Difficulty: *Medium*)
    ...
    * Related Topics: [*Tree*](https://leetcode.com/tag/tree/)
* [746. Min Cost Climbing Stairs](https://leetcode.com/problems/min-cost-climbing-stairs/) (Difficulty: *Easy*)
    * [**Solution**](https://github.com/cenkc/leetcode-studies/blob/master/src/main/java/com/cenkc/leetcode/study/all/MinCostClimbingStairs.java)
    * Related Topics: [*Array*](https://leetcode.com/tag/array/), [*Dynamic Programming*](https://leetcode.com/tag/dynamic-programming/)
